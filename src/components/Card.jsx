function Card({ dataObj }) {
  return (
    <div className="min-w-[20%] block max-w-sm p-1 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      <ul>
        <li>
