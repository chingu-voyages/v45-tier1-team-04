function Card({ dataObj }) {
  return (
    <div className="w-64 px-2 py-4 bg-slate-200 border border-gray-200 rounded-lg shadow hover:bg-gray-100  cursor-pointer">
      <ul>
        <li>
          <h2 className="text-2xl font-bold">Name: {dataObj.name}</h2>
        </li>
        <li>
